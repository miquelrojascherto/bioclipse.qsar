...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>bibtexml</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BibtexmlExample {
    /**
     * <!-- begin-user-doc -->
    ...
    public static void main(String[] args) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
            (Resource.Factory.Registry.DEFAULT_EXTENSION, 
             new BibtexmlResourceFactoryImpl());
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.bibtexml"));
                DocumentRoot documentRoot = BibtexmlFactory.eINSTANCE.createDocumentRoot();
                ArticleType root = BibtexmlFactory.eINSTANCE.createArticleType();
                documentRoot.setArticle(root);
