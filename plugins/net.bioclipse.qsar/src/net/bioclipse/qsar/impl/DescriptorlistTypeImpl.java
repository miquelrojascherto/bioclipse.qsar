 ...
 * <ul>
 *   <li>{@link net.bioclipse.qsar.impl.DescriptorlistTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptorlistTypeImpl extends EObjectImpl implements DescriptorlistType {
         ...
         * @ordered
         */
        protected EList<DescriptorType> descriptor;
        /**
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @generated
         ...
         * @generated
         */
        public EList<DescriptorType> getDescriptor() {
                if (descriptor == null) {
                        descriptor = new EObjectContainmentEList<DescriptorType>(DescriptorType.class, this, QsarPackage.DESCRIPTORLIST_TYPE__DESCRIPTOR);
                }
                return descriptor;
        }
        /**
        ...
        public void eSet(int featureID, Object newValue) {
                switch (featureID) {
                        case QsarPackage.DESCRIPTORLIST_TYPE__DESCRIPTOR:
                                getDescriptor().clear();
                                getDescriptor().addAll((Collection<? extends DescriptorType>)newValue);
                                return;
                }
