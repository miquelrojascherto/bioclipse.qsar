 ...
 *   <li>{@link net.bioclipse.qsar.impl.MoleculeResourceTypeImpl#getPath <em>Path</em>}</li>
 *   <li>{@link net.bioclipse.qsar.impl.MoleculeResourceTypeImpl#getSmiles <em>Smiles</em>}</li>
...
public class MoleculeResourceTypeImpl extends EObjectImpl implements MoleculeResourceType {
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QsarPackage.MOLECULE_RESOURCE_TYPE__PATH, oldPath, path));
	}
	...
	public void setSmiles(String newSmiles) {
		...
		smiles = newSmiles;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QsarPackage.MOLECULE_RESOURCE_TYPE__SMILES, oldSmiles, smiles));
	}
