...
public class TypeTwoDetailsPage implements IDetailsPage {
    ...
    public void createContents(Composite parent) {
        ...
        s1.marginWidth = 10;
        s1.setText("TypeTwoDetailsPage.name"); //$NON-NLS-1$
        s1.setDescription("TypeTwoDetailsPage.desc"); //$NON-NLS-1$
        ...
        flag1 = toolkit.createButton(client, "TypeTwoDetailsPage.flag1", SWT.CHECK); //$NON-NLS-1$
        ...
        flag2 = toolkit.createButton(client, "TypeTwoDetailsPage.flag2", SWT.CHECK); //$NON-NLS-1$
