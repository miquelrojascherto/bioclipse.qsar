...
public class QsarSwitch<T> {
        ...
        protected T doSwitch(int classifierID, EObject theEObject) {
                switch (classifierID) {
                        case QsarPackage.DESCRIPTORIMPL_TYPE: {
                                DescriptorimplType descriptorimplType = (DescriptorimplType)theEObject;
                                T result = caseDescriptorimplType(descriptorimplType);
                        ...
                        case QsarPackage.MOLECULELIST_TYPE: {
                                MoleculelistType moleculelistType = (MoleculelistType)theEObject;
                                T result = caseMoleculelistType(moleculelistType);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
                        case QsarPackage.MOLECULE_RESOURCE_TYPE: {
                                MoleculeResourceType moleculeResourceType = (MoleculeResourceType)theEObject;
                                T result = caseMoleculeResourceType(moleculeResourceType);
                                if (result == null) result = defaultCase(theEObject);
                                return result;
                        }
        ...
        /**
         * Returns the result of interpreting the object as an instance of '<em>Descriptorimpl Type</em>'.
         * <!-- begin-user-doc -->
         * This implementation returns null;
         * returning a non-null result will terminate the switch.
         * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Descriptorimpl Type</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
        public T caseDescriptorimplType(DescriptorimplType object) {
                return null;
        }
        /**
        ...
        /**
         * Returns the result of interpreting the object as an instance of '<em>Moleculelist Type</em>'.
         * <!-- begin-user-doc -->
         * This implementation returns null;
         * returning a non-null result will terminate the switch.
         * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Moleculelist Type</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
        public T caseMoleculelistType(MoleculelistType object) {
                return null;
        }
        /**
         * Returns the result of interpreting the object as an instance of '<em>Molecule Resource Type</em>'.
         * <!-- begin-user-doc -->
         * This implementation returns null;
         * returning a non-null result will terminate the switch.
         * <!-- end-user-doc -->
         * @param object the target of the switch.
         * @return the result of interpreting the object as an instance of '<em>Molecule Resource Type</em>'.
         * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
         * @generated
         */
        public T caseMoleculeResourceType(MoleculeResourceType object) {
                return null;
        }
        /**
