 ...
 *   <li>{@link net.sf.bibtexml.impl.ProceedingsTypeImpl#getDoi <em>Doi</em>}</li>
 *   <li>{@link net.sf.bibtexml.impl.ProceedingsTypeImpl#getUrl <em>Url</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProceedingsTypeImpl extends EObjectImpl implements ProceedingsType {
    ...
    public void setDoi(String newDoi) {
        ...
        doi = newDoi;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BibtexmlPackage.PROCEEDINGS_TYPE__DOI, oldDoi, doi));
    }
    ...
    public void setUrl(String newUrl) {
        ...
        url = newUrl;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BibtexmlPackage.PROCEEDINGS_TYPE__URL, oldUrl, url));
    }
