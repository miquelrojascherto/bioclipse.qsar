...
public class TypeOneDetailsPage implements IDetailsPage {
    ...
    public void createContents(Composite parent) {
        ...
        s1.setDescription("TypeOneDetailsPage.name"); //$NON-NLS-1$
        ...
        flag = toolkit.createButton(client, "TypeOneDetailsPage.check", SWT.CHECK); //$NON-NLS-1$
        ...
        toolkit.createLabel(client, "TypeOneDetailsPage.label"); //$NON-NLS-1$
