 ...
 *     Ola Spjuth - removed ADD/Remove buttons
 *******************************************************************************/
 ...
 * </p>
 */
public abstract class UpDownListEditor extends FieldEditor {
        /**
         ...
         */
        protected UpDownListEditor(String name, String labelText, Composite parent) {
                init(name, labelText);
